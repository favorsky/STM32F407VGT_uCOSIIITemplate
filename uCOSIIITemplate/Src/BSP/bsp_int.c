...
extern  void  BSP_IntHandlerButtonBlue(void);
extern  void  BSP_IntHandlerUSARTSec(void);
...
*********************************************************************************************************
*/
void BSP_IntInitButtonBlue(void)
{
	BSP_IntVectSet(BSP_INT_ID_EXTI0,BSP_IntHandlerButtonBlue);
...
void  BSP_IntInit (void)
{
    ...
    for (int_id = 0u; int_id < BSP_INT_SRC_NBR; int_id++) {
	   ...
	   BSP_IntVectSet(BSP_INT_ID_EXTI0,BSP_IntHandlerButtonBlue);
 	   BSP_IntVectSet(BSP_INT_ID_USART3,BSP_IntHandlerUSARTSec);
}
